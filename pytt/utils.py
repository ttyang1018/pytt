...
def GetVideoMetaInfoDictFromVideoFile(video_path):
    """
    {
        'streams': [{
            ...
            'tags': {
                'creation_time': '2020-12-15T13:43:07.000000Z',
                'language': 'und',
                'handler_name': 'Video track',
                'encoder': 'biquiti MP4 packer'
            }
        }],
        'format': {
            'filename':
            '/Users/lemon/temp/uc/uc/15___Garage_Entry___12_14_2020__4_29_11pm/video/15___Garage_Entry___12_14_2020__4_29_11pm.mp4',
            'nb_streams': 2,
            'nb_programs': 0,
